          ...
          context("when initialized with an audio data closure") {
            ...
            describe("#start()") {
              ...
              func itShouldPassInInitial(_ thing: String, setter: @escaping ((Double) -> (Void)), getter: @escaping (() -> (Double?))) {
                expectItShouldCheckValue(thing: thing, inbetweenFunction: {audioRecorder.start()}, setter: setter, getter: getter)
              }
              ...
              describe("#start()") {
                ...
                context("when the timer triggers") {
                  ...
                  func itShouldUpdateThe(_ thing: String, setter: @escaping ((Double) -> (Void)), getter: @escaping (() -> (Double?))) {
                    expectItShouldCheckValue(thing: thing, inbetweenFunction: mockTimer.tick, setter: setter, getter: getter)
                  }
...
func expectItShouldCheckValue(thing: String, inbetweenFunction: @escaping () -> (Void), setter: @escaping ((Double) -> (Void)), getter: @escaping (() -> (Double?))) {
